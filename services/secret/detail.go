...
func (s *Services) DetailSecret(ctx context.Context, req models.DetailQuery) models.Response {
	...
	sec, err := client.CoreV1().Secrets(req.Namespace).Get(ctx, req.Name, metav1.GetOptions{})
	if err != nil {
