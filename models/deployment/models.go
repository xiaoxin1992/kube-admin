...
type CreateDeployment struct {
	...
	Deployment appsv1.Deployment `json:"deployment" form:"deployment" binding:"required"`
}
...
type UpdateDeployment struct {
	Zone       string            `form:"zone" json:"zone" binding:"required"`
	Deployment appsv1.Deployment `form:"deployment" json:"deployment" binding:"required"`
}
